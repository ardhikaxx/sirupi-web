        ...
        <form action="{{ route('admin.program.update', $program->id) }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="kode" class="form-control @error('kode') is-invalid @enderror" value="{{ old('kode', $program->kode) }}" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="tahun_anggaran_id" class="form-control @error('tahun_anggaran_id') is-invalid @enderror" required>
                        ...
                        @foreach($tahunAnggarans as $ta)
                            <option value="{{ $ta->id }}" {{ old('tahun_anggaran_id', $program->tahun_anggaran_id) == $ta->id ? 'selected' : '' }}>{{ $ta->nama }} ({{ $ta->tahun }})</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea name="nama" class="form-control @error('nama') is-invalid @enderror" rows="3" required>{{ old('nama', $program->nama) }}</textarea>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="pagu_anggaran" class="form-control @error('pagu_anggaran') is-invalid @enderror" value="{{ old('pagu_anggaran', $program->pagu_anggaran) }}" required>
                    </div>
