...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('auditor.paket.index') }}">Data Paket</a></li>
...
<div class="card border-0 shadow-sm rounded-4 mb-3">
    <div class="card-header bg-white border-0 pt-4 px-4 d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('auditor.paket.index') }}" class="btn btn-outline-secondary btn-sm">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <table class="table table-bordered">
                    ...
                    <tr><th>Dibuat Oleh</th><td>{{ $paket->user->name ?? '-' }}</td></tr>
                </table>
            </div>
        </div>
    </div>
